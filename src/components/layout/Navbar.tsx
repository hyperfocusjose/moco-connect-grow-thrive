...
import { Bell, LayoutDashboard, Users, Calendar, ListCheck, LogIn, UserPlus } from 'lucide-react';
...
export const Navbar = () => {
  ...
  return <nav className="bg-maroon text-white sticky top-0 z-50 shadow-md">
      <div className="container mx-auto px-4 py-3">
        <div className="flex justify-between items-center">
          {/* Logo */}
          <Link to="/" className="flex items-center space-x-2 mx-[30px]">
            <span className="font-bold text-xl tracking-tighter px-0">MocoPNG</span>
          </Link>

          {/* Desktop Navigation Links */}
          {isAuthenticated && !isMobile && <div className="flex items-center space-x-1 md:space-x-4">
          ...
          <div className="flex items-center space-x-2">
            {isAuthenticated ? <DropdownMenu>
                ...
                <DropdownMenuContent className="w-56" align="end" forceMount>
                  ...
                  {currentUser?.isAdmin && <DropdownMenuItem asChild>
